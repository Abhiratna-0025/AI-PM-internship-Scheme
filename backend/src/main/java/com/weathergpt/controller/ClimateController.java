...
public class ClimateController {
    ...
    public ResponseEntity<ApiResponse<ClimateTrendResponse>> getClimateTrends(
        ...
        log.info("CLIMATE GET | ts={} | addr={} | UA=[{}] | location={} | startYear={} | endYear={}",
                Instant.now(), remoteAddr, userAgent, location, startYear, endYear);

        ClimateTrendResponse response = climateAnalysisService.analyzeClimateTrends(location, startYear, endYear);
